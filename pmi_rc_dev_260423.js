(function () {
  ...
  const REVIEW_FIELDNAME = "CustomFields.OBJ_981"; // Equipment QA memo field
  const STATUS_FIELD = "OBJ_982";                  // Equipment QA status field

  const PANEL_TITLE = "Maintenance Task QA Review";
