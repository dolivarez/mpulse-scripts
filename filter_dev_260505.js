(function () {
  ...
  function normalizeVisibleLinkPopupGrid() {
    ...
    if (/time\s*sheet\s*details/i.test(popupText)) {
      console.log("⏭️ Skipping popup grid normalization for Time Sheet Details");
      return;
    }
    ...
    if (!grid) {
      console.log("No popup grid found");
      return;
    }
    ...
    cols.forEach((col, i) => {
      const field = col.dataField || col.caption || "";
    ...
    console.log("✅ Popup grid normalized (2-column view)");
  }
