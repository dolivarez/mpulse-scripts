(function () {
  ...
  const REVIEW_FIELDNAME = "CustomFields.OBJ_927"; // Equipment QA memo field
  const STATUS_FIELD = "OBJ_978";                  // Equipment QA status field

  const PANEL_TITLE = "Equipment QA Review";
